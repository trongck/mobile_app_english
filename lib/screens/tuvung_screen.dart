...
class _TuVungScreenState extends State<TuVungScreen>
        ...
        children: [
          ...
          if (isSearching)
            ...
            Expanded(
              child: TabBarView(
                controller: _tabCtrl,
                children: [_ChuDeTab(), const _TatCaTab(), _OnTapTab()],
              ),
            ),
          ],
        ],
  ...
  Widget build(BuildContext context) {
    return Consumer<TuVungProvider>(
      builder: (_, p, __) {
        ...
        if (list.isEmpty)
          return _EmptyState(msg: 'Không tìm thấy từ "$search"', icon: '🔍');
        ...
        return Column(
          ...
          children: [
            Padding(
              ...
              child: Text(
                '${list.length} kết quả cho "$search"',
                style: TextStyle(
                  color: Colors.white.withOpacity(0.4),
                  fontSize: 12,
                ),
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (_, i) =>
                    _TuVungCard(tu: list[i], highlight: search),
              ),
            ),
          ],
        );
  ...
  Widget build(BuildContext context) {
    return Consumer<TuVungProvider>(
      builder: (_, p, __) {
        ...
        if (p.danhSachChuDe.isEmpty)
          return const _EmptyState(msg: 'Chưa có chủ đề nào', icon: '📂');
    ...
    return GestureDetector(
      ...
      onTapUp: (_) {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (_) =>
                _TuVungChuDeScreen(chuDe: widget.chuDe, color: widget.color),
          ),
        );
      },
  ...
  Widget build(BuildContext context) {
    return Consumer<TuVungProvider>(
      builder: (_, p, __) {
        ...
        if (p.tatCaTuVung.isEmpty)
          return const _EmptyState(msg: 'Không có từ vựng nào', icon: '🔍');
...
class _OnTapTabState extends State<_OnTapTab>
            ...
            children: [
              Consumer<TuVungProvider>(
                builder: (_, p, __) {
                  ...
                  if (p.tuYeuThich.isEmpty)
                    return const _EmptyState(
                      msg: 'Bạn chưa có từ yêu thích !',
                      icon: '❤️',
                    );
                  return ListView.builder(
                    physics: const BouncingScrollPhysics(),
              ...
              Consumer<TuVungProvider>(
                builder: (_, p, __) {
                  ...
                  if (p.tuDaHoc.isEmpty)
                    return const _EmptyState(
                      msg: 'Bạn chưa học từ nào !',
                      icon: '📚',
                    );
                  return ListView.builder(
                    physics: const BouncingScrollPhysics(),
        ...
        return GestureDetector(
          ...
          onTapUp: (_) {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => TuVungDetailScreen(tu: widget.tu),
              ),
            );
          },
          onTapCancel: () => setState(() => _pressed = false),
                      ...
                      if (widget.tu.nghiaVI != null)
                        _HighlightText(
                          ...
                          highlightStyle: TextStyle(
                            ...
                            fontSize: 13,
                            backgroundColor: const Color(0x1A00D4FF),
                          ),
                          maxLines: 1,
                        ),
                      _HighlightText(
...
class _TuVungDetailScreenState extends State<TuVungDetailScreen>
    with SingleTickerProviderStateMixin {
  final FlutterTts _tts = FlutterTts();
                        ...
                        if (nd != null) ...[
                          ...
                          GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: isDaHoc
                                      ? const Color(0xFF00FF94).withOpacity(0.5)
                                      : Colors.white.withOpacity(0.1),
                                ),
                              ),
                              child: Row(
                          ...
                          GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                color: isYeuThich
                                    ? const Color(0xFFFF3CAC).withOpacity(0.15)
                                    : Colors.white.withOpacity(0.06),
                                borderRadius: BorderRadius.circular(8),
                                border: Border.all(
                                  color: isYeuThich
                                      ? const Color(0xFFFF3CAC).withOpacity(0.5)
                                      : Colors.white.withOpacity(0.1),
                                ),
                              ),
                              child: Row(
    ...
    return Scaffold(
      ...
      body: Consumer<TuVungProvider>(
        builder: (_, p, __) {
          ...
          if (list.isEmpty)
            return _EmptyState(
              msg: _search.isNotEmpty
                  ? 'Không tìm thấy từ "$_search"'
          ...
          return ListView.builder(
            ...
            padding: const EdgeInsets.all(16),
            itemCount: list.length,
            itemBuilder: (_, i) => _TuVungCard(
              tu: list[i],
              highlight: _search.isNotEmpty ? _search : null,
            ),
          );
        },
      ),
