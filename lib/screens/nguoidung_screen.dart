...
class _NguoiDungScreenState extends State<NguoiDungScreen>
  ...
  Future<void> _saveProfile() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: ok
            ? const Color.fromARGB(255, 0, 255, 149).withOpacity(1)
                ...
                ElevatedButton(
                  ...
                  onPressed: isVerifying
                      ...
                      : () async {
                          ...
                          final success = await provider.xacMinhOtp(
                            otpController.text,
                          );
  ...
  Widget build(BuildContext context) {
    ...
    if (nd == null)
      return const Center(
        child: Text('Chưa đăng nhập', style: TextStyle(color: Colors.white)),
      );
                ...
                child: Center(
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 6),
                      GestureDetector(
                        onTap: nd.xacMinhEmail
                            ? null
                            : () async {
                                HapticFeedback.lightImpact();
                                final provider = context
                                    .read<NguoiDungProvider>();
                                ...
                                if (ok && context.mounted) {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        provider.error ?? 'Gửi OTP thất bại',
                                      ),
                  ...
                  children: [
                    ...
                    _editMode
                        ? _EditInfoSection(
                            ...
                            onTrinhDoChanged: (v) =>
                                setState(() => _selectedTrinhDo = v),
                            onMucTieuChanged: (v) =>
                                setState(() => _selectedMucTieu = v),
                            onPhutChanged: (v) =>
                                setState(() => _selectedPhut = v),
                          )
                        : Column(
                            children: [
                              _InfoRow(
...
class _EditInfoSection extends StatelessWidget {
  ...
  const _EditInfoSection({
    required this.trinhDo,
    required this.mucTieu,
    required this.mucTieuPhut,
    required this.onTrinhDoChanged,
    required this.onMucTieuChanged,
    required this.onPhutChanged,
  });
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Mục tiêu mỗi ngày: $mucTieuPhut phút',
                style: const TextStyle(
                  color: Colors.white,
                  fontSize: 13,
                  fontWeight: FontWeight.w600,
...
class _NhatKyChart extends StatelessWidget {
  ...
  const _NhatKyChart({
    required this.nhatKy7Ngay,
    required this.goal,
    required this.chuoiNgay,
  });
  @override
  Widget build(BuildContext context) {
